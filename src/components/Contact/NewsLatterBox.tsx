...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-lg bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="mb-10 border-b border-body-color border-opacity-25 pb-5 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        لا تتردد في الاتصال بنا للحصول على مساعدة أو لطرح أي استفسارات
      </p>
      <div className="space-y-5">
        <div className="flex items-center gap-3">
          <div className="center flex size-12 items-center justify-center rounded-full bg-black/10 p-2 text-xl dark:bg-white/10">
            <FaEnvelope />
          </div>
          <div className="text-md flex-1 text-start">
            <p className="text-xs uppercase opacity-50">البريد الإلكترونى</p>
            <Link href="mailto:almaherforbusiness@gmail.com">
              almaherforbusiness@gmail.com
            </Link>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <div className="text-md flex-1 text-start">
            <p className="text-xs uppercase opacity-50">رقم الهاتف</p>
            <Link href="https://wa.me/+972599339233">972599339233+</Link>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className="center flex size-12 items-center justify-center rounded-full bg-black/10 p-2 text-xl dark:bg-white/10">
          ...
          <div className="text-md flex-1 text-start">
            <p className="text-xs uppercase opacity-50">العنوان</p>
            <p>فلسطين – الضفة الغربية - سلفيت</p>
          </div>
        </div>
      </div>
      <div>
        <div className="mb-2 mt-10 flex items-center gap-3">
          <p className="mb-2 font-semibold">تواصل معنا عبر: </p>
          <div className="mb-1 h-[2px] w-10 rounded-lg bg-white" />
        </div>
